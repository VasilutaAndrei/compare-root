...
class ShopDialogCreate(ui.ScriptWindow):
	...
	def __LoadQuestionDialog(self):
		...
		if POSITION_FIX:
			self.UI["board"].SetSize(240, 170+30)
		else:
			self.UI["board"].SetSize(240, 180+30)
		self.UI["board"].SetCenterPosition()
...
class ShopEditWindow(ui.ScriptWindow):
	...
	def __Load(self):
		self.__Load_LoadScript("UIScript/PrivateShopBuilder.py")
	...
	def OnSelectEmptySlot(self, selectedSlotPos):
		...
		if isAttached:
			...
			priceInputBoard.SetMaxLength(13)
	...
	def EditPrice(self,slot):
		...
		self.priceInputBoard.SetMaxLength(13)
