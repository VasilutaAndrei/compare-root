...
class BlockChatWindow(ui.Window):
	...
	def BuildWindow(self):
		...
		self.Board.SetSize(260, 165)
		self.Board.SetCenterPosition()
		self.Board.AddFlag('movable')
		self.Board.AddFlag('float')
		self.Board.SetTitleName('Administrare Cybernetic ~Block Chat~')
		...
		self.slotbar_reason, self.reason    = self.comp.EditLine(self.Board, '', 55, 70, 160, 15, 30)
		self.slotbar_time, self.time        = self.comp.EditLine(self.Board, '', 55, 100, 160, 15, 30)
		...
		self.TTime = self.comp.TextLine(self.Board, 'Ore:', 21, 72, self.comp.RGB(255, 255, 255))
