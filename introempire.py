...
#3 Regate by [Tupeu]
	def OnOverInEmpire(self, arg):
		if arg == 1:
			...
			self.blue.LoadImage('twix_work/selectempirewindow/blue_1.tga')
	...
	def OnOverOutEmpire(self, arg):
		if arg == 1:
			...
			self.blue.LoadImage('twix_work/selectempirewindow/blue_0.tga')
